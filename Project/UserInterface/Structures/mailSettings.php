<?php ?>
<div id='MailSettings' style='display:none' class='container tabDiV'>
	...
	<div style="width:100%;float:left;margin-left:20px;margin-top:20px">
        <div style="float:left; width:40%">
            <table class="tableBorder1" cellpadding="3" cellspacing="3" style="margin:0">
                <caption>
                ...
                <tr>
                    <td colspan="3" align="center">
                        <button type="button" class="mediumButton jqxbutton c_p" name="Save" id="Save" onclick="SuperUser.SubmitSMTP();">Save</button>
                    </td>
                </tr>
            </table>
        </div>
